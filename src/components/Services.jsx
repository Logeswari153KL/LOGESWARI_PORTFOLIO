export default function Services() {
    ...
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am a passionate Full Stack Web Developer from India, currently building my career with strong foundational knowledge in modern web technologies. As a fresher, I am eager to gain industry experience and contribute to innovative projects in a reputed organization.</p>
