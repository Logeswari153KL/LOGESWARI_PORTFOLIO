export default function About() {
    ...
    const data = [
        ...
        },
        {
            ...
            description: 'B.COM ACCOUNTING AND FINANCE, FULL STACK WEB DEVELOPER, UI/UX DESIER, PHOTOGRAPHER, EDITOR',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am a passionate and enthusiastic Frontend Developer at the beginning of my professional journey. I have a strong interest in creating clean, user-friendly, and responsive web interfaces. During my learning phase, I have worked on various projects that helped me understand modern frontend technologies and design principles.

I am eager to start my career in a reputed organization where I can apply my skills, learn from experienced professionals, and contribute to meaningful projects. I am highly motivated, quick to learn, and ready to grow as a developer while adding value to the team.</p>

<a 
  href="/my-resume.pdf" 
  download="My_Resume.pdf"
  className="px-10 py-3 border rounded-full bg-black text-white flex items-center gap-2 w-max mt-5"
>
  Download Resume <img src="./assets/download-icon.png" alt="" className="w-4" />
</a>
